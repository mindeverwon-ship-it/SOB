...
const DATA_VERSION = 'v5'; // змінюйте при глобальному оновленні даних — скидає старий кеш
...
window.SOBStore = {
  ...
  init() {
    ...
    ['sob_data_v1','sob_data_v2','sob_data_v3','sob_data_v4'].forEach(k => localStorage.removeItem(k));
